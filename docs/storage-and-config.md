...
1. Host user-level skills: `~/.gemini/skills/` (or `~/.copilot/skills/`, `~/.claude/skills/`)
2. Workspace skills: `<workspace>/.copilot/skills/`, `<workspace>/.gemini/skills/`, `<workspace>/.claude/skills/`

Skills are synced into `~/.claude/skills/`, `~/.copilot/skills/`, and `~/.gemini/skills/`
